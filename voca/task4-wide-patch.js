(() => {
  ...
  source = source.replace(
    ...
    [
      ...
      "    const contentCount = tokens.filter((word) => !task4WeakWords.has(word)).length;",
      ...
      "  }",
      "",
      "  const task4WeakWords = new Set([\"a\", \"an\", \"the\", \"to\", \"of\", \"for\", \"with\", \"at\", \"in\", \"on\", \"and\", \"but\", \"or\", \"so\", \"as\", \"by\", \"from\"]);",
      "",
      "  function weakTailWord(word) {",
      "    return task4WeakWords.has(word) || word === \"i\" || word === \"you\" || word === \"he\" || word === \"she\" || word === \"we\" || word === \"they\";",
      "  }",
      "",
